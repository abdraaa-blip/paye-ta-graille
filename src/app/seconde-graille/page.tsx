...
export const metadata: Metadata = {
  ...
  description: `${GROWTH_MODULE_RESCUE.slogan} Surplus du jour près de chez toi : gratuit ou petit prix, sans culpabiliser, avec des limites pour éviter les abus.`,
};
  ...
  return (
    <div className="ptg-page">
      <PtgAppFlow>
        <div className="ptg-page-inner">
          <AppNav />
          <PtgMenuCard variant="sage" stamp="Du jour">
