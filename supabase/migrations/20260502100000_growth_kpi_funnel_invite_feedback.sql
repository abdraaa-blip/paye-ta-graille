-- Étend growth_kpi_daily : attributions invitation + feedback soumis (événements client désormais acceptés par l’API).
...
comment on view public.growth_kpi_daily is
  'Agrégats journaliers growth: funnel produit, invitations attribuées, feedback, partenaires, actifs.';
